...
\begin{figure}[H]
    ...
    \begin{tikzpicture}
        ...
        \addplot table[x=command, y=mean] {\realBenchmark};
        \addplot table[x=command, y=mean] {\realBenchmarkJIT};
        \addplot table[x=command, y=mean] {\realBenchmarkJITten};
        \addplot table[x=command, y=mean] {\realBenchmarkJIThundred};
        \legend{Jit disabled, Constant 1000, Constant 10000, Constant 100000}
        \end{axis}
    \end{tikzpicture}
    ...
    %         \addplot[color=blue,mark=*] table[x=command, y=mean] {\realBenchmark};
    %         \addplot[color=red,mark=square*,style=dashed] table[x=command, y=mean] {\realBenchmarkJIT};
    %         \addplot[color=violet,mark=triangle*,style=dotted] table[x=command, y=mean] {\realBenchmarkJITten};
    %         \addplot[color=green,mark=triangle*,style=loosely dashdotdotted] table[x=command, y=mean] {\realBenchmarkJIThundred};
    %         \legend{Jit disabled, Constant 1000, Constant 10000, Constant 100000, Constant 250000, Constant 500000, Constant 750000}
    %     \end{axis}
    % \end{tikzpicture}
